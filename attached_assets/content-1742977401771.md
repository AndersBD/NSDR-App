...
```\
\
### Explicit constructor options [\#](https://supabase.com/docs/reference/javascript/initializing\#explicit-constructor-options)\
\
...
```\
\
### TypeScript support [\#](https://supabase.com/docs/reference/javascript/initializing\#typescript-support)\
\
...
```\
\
### Data operations return minimal [\#](https://supabase.com/docs/reference/javascript/initializing\#data-operations-return-minimal)\
\
...
```\
\
### New ordering defaults [\#](https://supabase.com/docs/reference/javascript/initializing\#new-ordering-defaults)\
\
...
\
### Cookies and localstorage namespace [\#](https://supabase.com/docs/reference/javascript/initializing\#cookies-and-localstorage-namespace)\
\
...
```\
\
### New Auth Types [\#](https://supabase.com/docs/reference/javascript/initializing\#new-auth-types)\
\
...
```\
\
### New Auth methods [\#](https://supabase.com/docs/reference/javascript/initializing\#new-auth-methods)\
\
...
```\
\
### New Realtime methods [\#](https://supabase.com/docs/reference/javascript/initializing\#new-realtime-methods)\
\
...
```\
\
### Deprecated setAuth() [\#](https://supabase.com/docs/reference/javascript/initializing\#deprecated-setauth)\
\
...
\
### All changes [\#](https://supabase.com/docs/reference/javascript/initializing\#all-changes)\
\
- `supabase-js`\
