...
import { BarChart, ChevronLeft, File, LogOut, Settings } from 'lucide-react';
...
export default function AdminPage() {
  ...
  const adminLinks = [
    ...
    {
      title: 'Filstyring (Ikke tilgængelig)',
    ...
    {
      title: 'Indstillinger (Ikke tilgængelig)',
            ...
            {adminLinks.map((link, index) => (
              <motion.div key={link.title} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: index * 0.1 }}>
                ...
                >
                  ...
                  <CardContent>
                    {/* <Button variant="ghost" className="text-meditation-primary hover:bg-meditation-primary/10 w-full justify-start pl-2">
                      Åbn {link.title.toLowerCase()}
                    </Button> */}
                  </CardContent>
                </Card>
              </motion.div>
