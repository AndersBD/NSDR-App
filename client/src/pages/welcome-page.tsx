  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center">
      <div className="w-full max-w-3xl space-y-4">
        {/* App Logo */}
        <div
          className={cn('text-center relative p-8 transition-all duration-700 transform', animate ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8')}
        >
        ...
        <Card
          className={cn(
            'border-2 border-meditation-primary shadow-md transition-all duration-700 transform',
              ...
              <div className="bg-meditation-primary-light/30 p-5 rounded-lg border border-meditation-primary/20">
                ...
                <ul className="space-y-3">
                  <li className="flex gap-3">
                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-meditation-primary flex items-center justify-center text-white font-medium">1</div>
                    <div>
                  ...
                  <li className="flex gap-3">
                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-meditation-primary flex items-center justify-center text-white font-medium">2</div>
                    <div>
                  ...
                  <li className="flex gap-3">
                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-meditation-primary flex items-center justify-center text-white font-medium">3</div>
                    <div>
        ...
        {/* Buttons */}
        <div className={cn('grid gap-4 transition-all duration-700 transform', animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8')}>
          <Button
            size="lg"
